...
const projects=[
    {
    ...
    },
     {
        id:4,
        title:"Emoji Game",
        description:"Test your memory by clicking each emoji only once. Can you beat your top score? 🧠✨",
                 ...
                 {projects.map((project,key)=>(
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex space-x-3">
                            <a href={project.domainUrl} className="text-foreground/80 hover:text-primary transition-colors duration-300"
                            target="_blank">
